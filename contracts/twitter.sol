...
// contract address: 0x5a7095175AfbDD4F3736be7f8D846345c09d2D75
contract Twitter {
    address public owner;
    uint256 private counter; // represent ID for tweet
    ...
    mapping(uint256 => tweet) Tweets; // id to tweet
    ...
    // Method to get all Tweets of a User
    ...
    function deleteTweet(uint tweetId, bool isDeleted) external {
        ...
        emit TweetDeleted(Tweets[tweetId].id, Tweets[tweetId].isDeleted);
    }
